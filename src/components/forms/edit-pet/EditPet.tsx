...
import {
  PetDTO, PetGender, PetSize, PetType,
} from '../../../types/PetsDTO';
...
const EditPet: React.FC<EditPetProps> = ({ pet }) => {
  ...
  const validationSchema = yup.object().shape({
    ...
    avatar: yup.string().url().nullable().required('Поле обязательно для заполнения'),
  ...
  return (
    <div>
      ...
      <Modal visible={isModalVisible} footer={null} maskClosable onCancel={closeModal}>
        <Formik
          initialValues={pet}
